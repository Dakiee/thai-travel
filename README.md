...
A personal Thailand group trip board from Ulaanbaatar, built with Next.js 16, React 19 and the App Router.
...
| Stay | Hotel | Guests | Nights | Dates |
|---|---|---:|---:|---|
| Bangkok | Hotel Ordinary Bangkok | 5 | 3 | Jan 16–19 |
| Ao Nang (Krabi) | ibis Styles Krabi Ao Nang | 5 | 3 | Jan 19–22 |
| Koh Lanta | Rattana Resort, Lanta Noi | 5 | 2 | Jan 22–24 |
| Koh Phi Phi | Phi Phi Don Chukit Resort | 5 → 7 | 2 | Jan 24–26 |
| Phuket | To be added | 7 | 4 | Jan 26–30 |
| Bangkok | Baiyoke Sky Hotel | 7 | 2 | Jan 30–Feb 1 |

The app is split into five routes:

- `/` — trip overview, route and interactive map
- `/itinerary` — the complete day-by-day
- `/stays` — booked hotels, stay dates and guest counts
...
- `planner.js` is the tested source of truth for hotels, map locations, route data and budget calculations.
